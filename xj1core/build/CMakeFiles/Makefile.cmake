...
set(CMAKE_MAKEFILE_DEPENDS
  ...
  "flash_args.in"
  "ldgen_libraries.in"
  "../components/ini_parser/CMakeLists.txt"
  "../main/CMakeLists.txt"
  "../partitions.csv"
  "../sdkconfig"
  "/usr/local/esp-idf-v5.4.1/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/app_trace/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/app_trace/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/app_update/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/bootloader/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/bootloader/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/bootloader_support/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/bt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/cmock/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/console/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/cxx/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/driver/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/efuse/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/efuse/esp32s3/sources.cmake"
  "/usr/local/esp-idf-v5.4.1/components/esp-tls/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_adc/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_app_format/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_bootloader_format/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_coex/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_common/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_common/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_ana_cmpr/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_cam/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_dac/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_gpio/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_gptimer/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_i2c/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_i2s/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_isp/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_jpeg/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_ledc/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_mcpwm/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_parlio/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_pcnt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_ppa/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_rmt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_sdio/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_sdm/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_sdmmc/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_sdspi/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_spi/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_touch_sens/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_tsens/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_uart/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_driver_usb_serial_jtag/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_eth/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_event/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_gdbstub/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_hid/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_http_client/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_http_server/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_https_ota/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_https_server/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_hw_support/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_hw_support/lowpower/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_hw_support/port/esp32s3/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_lcd/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_local_ctrl/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_mm/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_netif/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_netif_stack/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_partition/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_phy/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_pm/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_psram/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_psram/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/esp_ringbuf/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_rom/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_security/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_system/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_system/ld/ld.cmake"
  "/usr/local/esp-idf-v5.4.1/components/esp_system/port/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_system/port/soc/esp32s3/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_timer/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_vfs_console/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esp_wifi/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/espcoredump/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esptool_py/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/esptool_py/espefuse.cmake"
  "/usr/local/esp-idf-v5.4.1/components/esptool_py/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/fatfs/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/fatfs/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/freertos/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/hal/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/heap/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/http_parser/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/idf_test/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/ieee802154/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/json/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/log/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/lwip/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/3rdparty/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/3rdparty/everest/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/3rdparty/p256-m/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/include/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/library/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mbedtls/mbedtls/pkgconfig/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mqtt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/mqtt/esp-mqtt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/newlib/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/newlib/port/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/newlib/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/nvs_flash/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/nvs_flash/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/nvs_sec_provider/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/openthread/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/partition_table/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/partition_table/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/perfmon/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/protobuf-c/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/protocomm/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/pthread/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/rt/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/sdmmc/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/soc/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/spi_flash/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/spiffs/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/spiffs/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/tcp_transport/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/touch_element/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/ulp/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/ulp/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/components/unity/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/usb/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/vfs/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/wear_levelling/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/wifi_provisioning/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/wpa_supplicant/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/xtensa/CMakeLists.txt"
  "/usr/local/esp-idf-v5.4.1/components/xtensa/project_include.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/build.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/component.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/depgraph.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/dfu.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/gdbinit.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/git_submodules.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/idf.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/kconfig.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/ldgen.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/openocd.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/prefix_map.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/project.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/project_description.json.in"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/symbols.gdbinit.in"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/targets.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/third_party/GetGitRevisionDescription.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/tool_version_check.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/toolchain-esp32s3.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/utilities.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/cmake/version.cmake"
  "/usr/local/esp-idf-v5.4.1/tools/kconfig_new/confgen.py"
  "/usr/local/esp-idf-v5.4.1/tools/kconfig_new/config.env.in"
...
set(CMAKE_MAKEFILE_PRODUCTS
  ...
  "esp-idf/ini_parser/CMakeFiles/CMakeDirectoryInformation.cmake"
...
set(CMAKE_DEPEND_INFO_FILES
  ...
  "CMakeFiles/xj1core.elf.dir/DependInfo.cmake"
  ...
  "esp-idf/ini_parser/CMakeFiles/__idf_ini_parser.dir/DependInfo.cmake"
